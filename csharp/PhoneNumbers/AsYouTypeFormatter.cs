...
namespace PhoneNumbers
{
    ...
    public class AsYouTypeFormatter
    {
        ...
        private static readonly Regex CHARACTER_CLASS_PATTERN = new Regex("\\[([^\\[\\]])*\\]", Redirections.Compiled);
        ...
        private static readonly Regex STANDALONE_DIGIT_PATTERN = new Regex("\\d(?=[^,}][^,}])", Redirections.Compiled);
